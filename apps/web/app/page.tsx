...
export const metadata: Metadata = {
  title: "Black Polar — Technology Services",
  description:
    "Black Polar is a technology services firm specializing in mission-critical infrastructure, threat defense, and digital transformation.",
  keywords: "technology, services, cybersecurity, systems administration, consulting",
  authors: [{ name: "BLACK POLAR GROUP" }],
  icons: { icon: "/assets/main/image/favicon.ico" },
  openGraph: {
    title: "Black Polar",
    description: "Black Polar — precision-engineered technology services.",
...
<div className="marquee-band">
  <div className="marquee-track">
    <span className="marquee-item">Technology Services</span>
    <span className="marquee-sep">◆</span>
    <span className="marquee-item">Cybersecurity</span>
    <span className="marquee-sep">◆</span>
    <span className="marquee-item">Systems Administration</span>
    <span className="marquee-sep">◆</span>
    <span className="marquee-item">Strategic Consulting</span>
    <span className="marquee-sep">◆</span>
    <span className="marquee-item">Cloud Infrastructure</span>
    <span className="marquee-sep">◆</span>
    <span className="marquee-item">Network Engineering</span>
    <span className="marquee-sep">◆</span>
    ...
    <section id="portfolio" className="portfolio-section">
      <div className="portfolio-inner">
        <div className="portfolio-header">
          <p className="section-label reveal">003 — Our Work</p>
          <div className="section-rule reveal reveal-delay-1"></div>
          <h2 className="section-title reveal reveal-delay-1">Portfolio</h2>
        </div>

        {/* Rendered by main.js */}
        <div className="portfolio-grid" id="portfolio-grid"></div>
      </div>
    </section>
    ...
    <section id="contact" className="contact-section">
      <div className="contact-inner">
        ...
        <div className="contact-info">
          <p className="section-label reveal">004 — Get In Touch</p>
          <div className="section-rule reveal reveal-delay-1"></div>
...
<footer className="site-footer">
  <div className="footer-top">
    ...
    <a href="/login" className="btn-primary" style={{ fontSize: '0.62rem', padding: '11px 24px' }}>Get Started</a>
  </div>
